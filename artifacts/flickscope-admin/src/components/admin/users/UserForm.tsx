  ...
  if (mode === "create" && !canCreateAccounts) {
    return (
      <div className="mx-auto max-w-xl rounded-3xl border border-white/10 bg-[#0B1026] p-8 text-center shadow-2xl">
        ...
        <button type="button" onClick={() => window.history.back()} className="mt-6 rounded-xl border border-white/10 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-300 hover:bg-white/10">Go Back</button>
      </div>
    );
  }
