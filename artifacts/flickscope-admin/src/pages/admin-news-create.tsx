...
export default function CreateNewsPage() {
  ...
  async function createNews() {
    ...
    try {
      ...
      setLocation(`/admin/news/${result.data.id}`);
    } catch (cause) {
