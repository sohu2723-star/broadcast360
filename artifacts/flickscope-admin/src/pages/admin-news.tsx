    ...
    <div className="min-h-screen bg-[#010312] p-4 sm:p-6 text-white font-sans">
      <div className="mx-auto max-w-7xl space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/5 pb-4">
          ...
          <Link href="/news/create" className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#4f6689] to-[#400FD3] px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-[#400FD3]/20 transition-all hover:opacity-90 active:scale-95">
            <Plus size={16} />
            Create News
          </Link>
        </div>
