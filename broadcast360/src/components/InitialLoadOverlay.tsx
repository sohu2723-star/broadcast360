...
export default function InitialLoadOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#010312] text-white">
      <div className="flex items-center gap-3 rounded-2xl border border-cyan-200/10 bg-[#111936]/90 px-5 py-4 text-sm text-slate-300 shadow-xl">
