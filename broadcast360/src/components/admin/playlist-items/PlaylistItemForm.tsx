...
export default function PlaylistItemForm({
  ...
  async function submit() {
    ...
    try {
      ...
      router.push(`/admin/programs/${programId}/playlists/${playlistId}`);
  ...
  return (
    <div className="max-w-xl space-y-6">
      ...
      <div>
        <label className="mb-2 block text-white">Content Type</label>
      ...
      <div>
        <label className="mb-2 block text-white">Sequence Order</label>
        ...
        <input
          ...
          className="w-full rounded-lg bg-[#0B1026] p-3 text-white"
        />
      </div>
